  ...
  productShowcase: {
    ...
    series: [
    {
      ...
      products: [
        {
          category: "Sofas",
          name: "Tailored Sofa 01",
          description: "Tailored upholstered sofa with a refined silhouette for light luxury living spaces.",
          images: ["/assets/products/light-luxury/sofa-01.jpg", "/assets/products/light-luxury/sofa-01-detail.jpg"],
        },
        {
          category: "Sofas",
          name: "Cloud Modular Sofa",
          description: "One modular sofa shown in three matching configurations and close-up details.",
          images: ["/assets/products/light-luxury/sofa-02.jpg", "/assets/products/light-luxury/sofa-02-detail.jpg", "/assets/products/light-luxury/sofa-02-detail-2.jpg"],
        },
        {
          category: "Sofas",
          name: "Ribbed Lounge Sofa",
          description: "A single ribbed lounge sofa shown in a full view and a material-focused detail.",
          images: ["/assets/products/light-luxury/sofa-03.jpg", "/assets/products/light-luxury/sofa-03-detail.jpg"],
        },
        {
          category: "Sofas",
          name: "Black Lounge Sofa",
          description: "Statement sofa composition designed for private villas and hospitality interiors.",
          images: ["/assets/products/light-luxury/sofa-04.jpg", "/assets/products/light-luxury/sofa-04-detail.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 01",
          description: "Wide upholstered bed with a structured headboard and calm bedroom presence.",
          images: ["/assets/products/light-luxury/bed-01.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 02",
          description: "A dark statement headboard paired with a tailored upholstered base.",
          images: ["/assets/products/light-luxury/bed-02.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 03",
          description: "Soft contemporary bed system with generous proportions for suites and villas.",
          images: ["/assets/products/light-luxury/bed-03.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 04",
          description: "Elegant upholstered bed with a layered headboard and refined bedside composition.",
          images: ["/assets/products/light-luxury/bed-04.jpg"],
        },
        {
          category: "Dining & Coffee Tables",
          name: "Leafwork Table Collection",
          description: "Coordinated central and side tables with the same leaf-inspired metal base.",
          images: ["/assets/products/light-luxury/table-01.jpg", "/assets/products/light-luxury/table-01-detail.jpg", "/assets/products/light-luxury/table-01-detail-2.jpg"],
        },
        {
          category: "Dining & Coffee Tables",
          name: "Stone Table Collection 02",
          description: "A coordinated group of stone occasional tables from one design series.",
          images: ["/assets/products/light-luxury/table-02.jpg", "/assets/products/light-luxury/table-02-detail.jpg", "/assets/products/light-luxury/table-02-detail-2.jpg"],
        },
          {
            category: "Dining & Coffee Tables",
            name: "Motif Nesting Table Set",
            description: "A coordinated trio of round occasional tables with matching graphic tops and gold frames.",
            images: [
              "/assets/products/light-luxury/table-03-motif-set.jpg",
              "/assets/products/light-luxury/table-03-motif-detail.jpg",
            ],
          },
          {
            category: "Dining & Coffee Tables",
            name: "Gold Tray Table Set",
            description: "A three-piece occasional table set with the same polished tray top and looped gold base.",
            images: [
              "/assets/products/light-luxury/table-04-gold-set.jpg",
              "/assets/products/light-luxury/table-04-gold-single.jpg",
              "/assets/products/light-luxury/table-04-gold-detail.jpg",
            ],
        },
        {
          category: "Chairs",
          name: "Onyx Chair Collection",
          description: "Dining, armchair, and lounge seating developed in one black-and-cream series.",
          images: ["/assets/products/light-luxury/chair-01.jpg", "/assets/products/light-luxury/chair-01-detail.jpg", "/assets/products/light-luxury/chair-01-detail-2.jpg"],
        },
        {
          category: "Chairs",
          name: "Tufted Chair Collection",
          description: "Coordinated tufted lounge and dining seating from the same warm wood series.",
          images: ["/assets/products/light-luxury/tufted-armchair.jpg", "/assets/products/light-luxury/tufted-dining-chair.jpg"],
        },
          {
            category: "Chairs",
            name: "Arc Lounge Chair Collection",
            description: "A soft lounge chair with sculpted dark wood arms, shown in its complete living room setting.",
            images: [
              "/assets/products/light-luxury/chair-03-arc-context.jpg",
              "/assets/products/light-luxury/chair-03-arc-pair.jpg",
            ],
          },
        {
          category: "Chairs",
          name: "Chair 04",
          description: "Contemporary occasional chairs selected for complete interior matching.",
          images: ["/assets/products/light-luxury/chair-04.jpg"],
        },
      ],
    },
    {
