    ...
    series: [
    {
      ...
      products: [
        ...
        },
        {
          category: "Sofas",
          name: "Sofa 02",
          description: "A sculptural upholstered sofa with generous seating and a confident color statement.",
          images: ["/assets/products/light-luxury/sofa-02.jpg", "/assets/products/light-luxury/sofa-02-detail.jpg"],
        },
        {
          category: "Sofas",
          name: "Sofa 03",
          description: "Soft modular seating with clean geometry and a polished metal accent.",
        ...
        },
        {
          ...
          images: ["/assets/products/light-luxury/bed-01.jpg", "/assets/products/light-luxury/bed-01-detail.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 02",
          description: "A dark statement headboard paired with a tailored upholstered base.",
          images: ["/assets/products/light-luxury/bed-02.jpg", "/assets/products/light-luxury/bed-02-detail.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 03",
          description: "Soft contemporary bed system with generous proportions for suites and villas.",
          images: ["/assets/products/light-luxury/bed-03.jpg", "/assets/products/light-luxury/bed-03-detail.jpg"],
        },
        {
          category: "Upholstered Beds",
          name: "Bed 04",
          description: "Elegant upholstered bed with a layered headboard and refined bedside composition.",
          images: ["/assets/products/light-luxury/bed-04.jpg", "/assets/products/light-luxury/bed-04-detail.jpg"],
        },
        {
          category: "Dining & Coffee Tables",
          name: "Table 01",
          description: "Stone-topped table collection with an architectural metallic base.",
          images: ["/assets/products/light-luxury/table-01.jpg", "/assets/products/light-luxury/table-01-detail.jpg"],
        },
        {
          category: "Dining & Coffee Tables",
          name: "Table 02",
          description: "Dark stone occasional tables with slim, refined supports.",
          images: ["/assets/products/light-luxury/table-02.jpg", "/assets/products/light-luxury/table-02-detail.jpg"],
        },
        {
          category: "Dining & Coffee Tables",
          name: "Table 03",
          description: "Rounded coffee table forms with warm stone surfaces and a sculptural base.",
          images: ["/assets/products/light-luxury/table-03.jpg", "/assets/products/light-luxury/table-03-detail.jpg"],
        },
        {
          category: "Dining & Coffee Tables",
          name: "Table 04",
          description: "Compact side and coffee tables for coordinated light luxury interiors.",
          images: ["/assets/products/light-luxury/table-04.jpg", "/assets/products/light-luxury/table-04-detail.jpg"],
        },
        {
          category: "Chairs",
          name: "Chair 01",
          description: "Curved lounge seating with a softly upholstered back and refined frame.",
          images: ["/assets/products/light-luxury/chair-01.jpg", "/assets/products/light-luxury/chair-01-detail.jpg"],
        },
        {
          category: "Chairs",
          name: "Chair 02",
          description: "Elegant dining chair silhouettes for villas, offices, and hospitality projects.",
          images: ["/assets/products/light-luxury/chair-02.jpg", "/assets/products/light-luxury/chair-02-detail.jpg"],
        },
        {
          category: "Chairs",
          name: "Chair 03",
          description: "Upholstered accent seating with tailored detailing and a soft profile.",
          images: ["/assets/products/light-luxury/chair-03.jpg", "/assets/products/light-luxury/chair-03-detail.jpg"],
        },
        {
          category: "Chairs",
          name: "Chair 04",
          description: "Contemporary occasional chairs selected for complete interior matching.",
          images: ["/assets/products/light-luxury/chair-04.jpg", "/assets/products/light-luxury/chair-04-detail.jpg"],
        },
      ],
    },
    {
