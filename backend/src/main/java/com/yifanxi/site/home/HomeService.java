    ...
    private ProductShowcase productShowcase() {
        return new ProductShowcase(
                ...
                new ProductSeries(
                        ...
                        List.of(
                                new ProductItem("Sofas", "Tailored Sofa 01", "Tailored upholstered sofa with a refined silhouette for light luxury living spaces.", List.of("/assets/products/light-luxury/sofa-01.jpg", "/assets/products/light-luxury/sofa-01-detail.jpg")),
                                new ProductItem("Sofas", "Cloud Modular Sofa", "One modular sofa shown in three matching configurations and close-up details.", List.of("/assets/products/light-luxury/sofa-02.jpg", "/assets/products/light-luxury/sofa-02-detail.jpg", "/assets/products/light-luxury/sofa-02-detail-2.jpg")),
                                new ProductItem("Sofas", "Ribbed Lounge Sofa", "A single ribbed lounge sofa shown in a full view and a material-focused detail.", List.of("/assets/products/light-luxury/sofa-03.jpg", "/assets/products/light-luxury/sofa-03-detail.jpg")),
                                new ProductItem("Sofas", "Black Lounge Sofa", "Statement sofa composition designed for private villas and hospitality interiors.", List.of("/assets/products/light-luxury/sofa-04.jpg", "/assets/products/light-luxury/sofa-04-detail.jpg")),
                                ...
                                new ProductItem("Dining & Coffee Tables", "Leafwork Table Collection", "Coordinated central and side tables with the same leaf-inspired metal base.", List.of("/assets/products/light-luxury/table-01.jpg", "/assets/products/light-luxury/table-01-detail.jpg", "/assets/products/light-luxury/table-01-detail-2.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Stone Table Collection 02", "A coordinated group of stone occasional tables from one design series.", List.of("/assets/products/light-luxury/table-02.jpg", "/assets/products/light-luxury/table-02-detail.jpg", "/assets/products/light-luxury/table-02-detail-2.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Motif Nesting Table Set", "A coordinated trio of round occasional tables with matching graphic tops and gold frames.", List.of("/assets/products/light-luxury/table-03-motif-set.jpg", "/assets/products/light-luxury/table-03-motif-detail.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Gold Tray Table Set", "A three-piece occasional table set with the same polished tray top and looped gold base.", List.of("/assets/products/light-luxury/table-04-gold-set.jpg", "/assets/products/light-luxury/table-04-gold-single.jpg", "/assets/products/light-luxury/table-04-gold-detail.jpg")),
                                new ProductItem("Chairs", "Onyx Chair Collection", "Dining, armchair, and lounge seating developed in one black-and-cream series.", List.of("/assets/products/light-luxury/chair-01.jpg", "/assets/products/light-luxury/chair-01-detail.jpg", "/assets/products/light-luxury/chair-01-detail-2.jpg")),
                                new ProductItem("Chairs", "Tufted Chair Collection", "Coordinated tufted lounge and dining seating from the same warm wood series.", List.of("/assets/products/light-luxury/tufted-armchair.jpg", "/assets/products/light-luxury/tufted-dining-chair.jpg")),
                                new ProductItem("Chairs", "Arc Lounge Chair Collection", "A soft lounge chair with sculpted dark wood arms, shown in its complete living room setting.", List.of("/assets/products/light-luxury/chair-03-arc-context.jpg", "/assets/products/light-luxury/chair-03-arc-pair.jpg")),
