        ...
        return new ProductShowcase(
                ...
                new ProductSeries(
                        ...
                        List.of(
                                ...
                                new ProductItem("Sofas", "Sofa 02", "A sculptural upholstered sofa with generous seating and a confident color statement.", List.of("/assets/products/light-luxury/sofa-02.jpg", "/assets/products/light-luxury/sofa-02-detail.jpg")),
                                new ProductItem("Sofas", "Sofa 03", "Soft modular seating with clean geometry and a polished metal accent.", List.of("/assets/products/light-luxury/sofa-03.jpg", "/assets/products/light-luxury/sofa-03-detail.jpg")),
                                new ProductItem("Sofas", "Sofa 04", "Statement sofa composition designed for private villas and hospitality interiors.", List.of("/assets/products/light-luxury/sofa-04.jpg", "/assets/products/light-luxury/sofa-04-detail.jpg")),
                                new ProductItem("Upholstered Beds", "Bed 01", "Wide upholstered bed with a structured headboard and calm bedroom presence.", List.of("/assets/products/light-luxury/bed-01.jpg", "/assets/products/light-luxury/bed-01-detail.jpg")),
                                new ProductItem("Upholstered Beds", "Bed 02", "A dark statement headboard paired with a tailored upholstered base.", List.of("/assets/products/light-luxury/bed-02.jpg", "/assets/products/light-luxury/bed-02-detail.jpg")),
                                new ProductItem("Upholstered Beds", "Bed 03", "Soft contemporary bed system with generous proportions for suites and villas.", List.of("/assets/products/light-luxury/bed-03.jpg", "/assets/products/light-luxury/bed-03-detail.jpg")),
                                new ProductItem("Upholstered Beds", "Bed 04", "Elegant upholstered bed with a layered headboard and refined bedside composition.", List.of("/assets/products/light-luxury/bed-04.jpg", "/assets/products/light-luxury/bed-04-detail.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Table 01", "Stone-topped table collection with an architectural metallic base.", List.of("/assets/products/light-luxury/table-01.jpg", "/assets/products/light-luxury/table-01-detail.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Table 02", "Dark stone occasional tables with slim, refined supports.", List.of("/assets/products/light-luxury/table-02.jpg", "/assets/products/light-luxury/table-02-detail.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Table 03", "Rounded coffee table forms with warm stone surfaces and a sculptural base.", List.of("/assets/products/light-luxury/table-03.jpg", "/assets/products/light-luxury/table-03-detail.jpg")),
                                new ProductItem("Dining & Coffee Tables", "Table 04", "Compact side and coffee tables for coordinated light luxury interiors.", List.of("/assets/products/light-luxury/table-04.jpg", "/assets/products/light-luxury/table-04-detail.jpg")),
                                new ProductItem("Chairs", "Chair 01", "Curved lounge seating with a softly upholstered back and refined frame.", List.of("/assets/products/light-luxury/chair-01.jpg", "/assets/products/light-luxury/chair-01-detail.jpg")),
                                new ProductItem("Chairs", "Chair 02", "Elegant dining chair silhouettes for villas, offices, and hospitality projects.", List.of("/assets/products/light-luxury/chair-02.jpg", "/assets/products/light-luxury/chair-02-detail.jpg")),
                                new ProductItem("Chairs", "Chair 03", "Upholstered accent seating with tailored detailing and a soft profile.", List.of("/assets/products/light-luxury/chair-03.jpg", "/assets/products/light-luxury/chair-03-detail.jpg")),
                                new ProductItem("Chairs", "Chair 04", "Contemporary occasional chairs selected for complete interior matching.", List.of("/assets/products/light-luxury/chair-04.jpg", "/assets/products/light-luxury/chair-04-detail.jpg"))
                        )
                ),
                new ProductSeries(
                        "minimal",
